...
public class VitalSigns {
    ...
    public String toString() {
        return "VitalSigns{" + "year=" + year + ", month=" + month + ", day=" + day + ", respiratoryRate=" + respiratoryRate + ", heartRate=" + heartRate + ", sysBloodPressure=" + sysBloodPressure + ", weightKg=" + weightKg + ", weightLb=" + weightLb + '}';
    }
